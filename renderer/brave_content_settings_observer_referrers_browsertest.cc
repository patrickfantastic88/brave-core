...
IN_PROC_BROWSER_TEST_F(BraveContentSettingsObserverBrowserTest, BlockThirdPartyReferrerByDefault) {
  ...
  content_settings->GetSettingsForOneType(
      CONTENT_SETTINGS_TYPE_PLUGINS, "referer", &fp_settings);
  ...
  EXPECT_EQ(fp_settings[0].secondary_pattern, ContentSettingsPattern::Wildcard()) <<
      "Secondary pattern of default referrer rule should be the special "
